...
cprintf(" ::  RECORD DISPLAY SECTION  ::");
gotoxy(12,6);textcolor(3);textbackground(0);
cprintf("1. Rollno :");
cout<<rollno;
gotoxy(12,7);textcolor(3);
...
{ char nm[20],fath[15],moth[15],h[15],s;
int rno,d,m,y,c;
clrscr();
...
cprintf("--------------------------------------------------------------------------");
gotoxy(1,4);
cprintf(" Name     Rollno   Class   House.   DateofBirth    Fathername      Mothername  ");
gotoxy(1,5);
cprintf("---------------------------------------------------------------------------  ");
textcolor(7);
ifstream fff;
...
case 1:     clrscr();
	   ...
	   clrscr();
	    ...
	    cprintf("Do u want to add more record(y/n)\t");
                                                              cin>>ch;
	    }while(ch=='y'||ch=='Y');
	    fout.close();
	    goto  start;
